...
% // TODO Brief intro to pilot study
...
\label{subsec:pilotStudyAnalysis}
...
\label{subsec:pilotStudyObservations}
...
Through using the improvement of a pause during the control sequence, as suggested in Section~\ref{subsec:pilotStudyObservations}, a number of these errors could be countered.
...
\label{subsubsec:pilotStudyObservationsIssues}
...
The issues outlined in Section~\ref{subsubsec:pilotStudyObservationsIssues} were noted in the previous phase of the study to make the use of the system counter-productive.
...
With clear definitions of the issues in Section~\ref{subsubsec:pilotStudyObservationsIssues} and their potential solutions in Section~\ref{subsec:studyResolvingIssues}, improvements can be implemented in SynergyNet.
...
\subsubsection{Task 1: Board Only}
\label{subsubsec:studyResultsTask1}
...
\subsubsection{Task 2: Tablet Only}
\label{subsubsec:studyResultsTask2}
...
\subsubsection{Task 3: Kinect Only}
\label{subsubsec:studyResultsTask3}
...
\label{subsubsec:studyResultsTask4}
...
\label{subsubsec:studyResultsSummary}
...
\subsection{Observations}
\label{subsec:studyObservations}
...
This is a great improvement over the previous study's error rate and indicates that the hypothesis of a significantly reduced error rate given in Section~\ref{subsec:studyResults} was correct.
...
\label{subsubsec:studyObservationsSuccess}
...
\label{subsubsec:studyObservationsResolution}
...
\label{subsubsec:studyObservationsFulfilment}
...
In Section~\ref{subsubsec:pilotStudyObservationsIssues} the possibility of the Kinect device having difficulty tracking fast moving joints was raised.
