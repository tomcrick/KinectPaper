% TODO Restructure as so:
% Abstract
% Introduction
% Background
% The Problem: Teacher Control
% --- RQ: Whats a better control mechanism for teachers: smart boards, tablets or the Kinect?
% Implementation
% -- Detail full developments (i.e. support for multiple Kinects and different command issueing trees)
% Study Design
% -- Highlight need for a suitable gesture set to be generated
% -- Highlight need for an interative design due to explore alternative implementations, therefore multiple phases to the study.
% - Gathering User Generated Gestures
% Study: Phase 1
% - Design
% -- Single Kinect with the original gesture tree.
% - Results
% - Observations
% -- Note how the Kinect's poor range and tracking of movement were hugely problematic and needed to be corrected for any further studies.
% Study: Phase 2
% - Design
% -- Two Kinects with an improved gesture tree intended to counter the Kinect's limitations.
% - Results
% - Observations
% Conclusion
...
% TODO May need to include Liz Burd and Emma Mercier, contact them to see if they want including (and if so if they'll help proof)?

\begin{abstract}

% TODO Merge abstracts to tell the full story: Guessability study -> User Study 1 - > Improvements - User Study 2
...
% TODO Extend with elements from Introduction 2 to explain how improvements are needed to make Open-Air gestures usable.

% TODO Update Summary of Structure at the end.
...
% TODO Trim down (subsection on potential issues could be summarised (its just reasoning for the limitations on acceptable gestures which we used to determine what we asked the participants.)

% TODO Merge next 3 sections?
...
% TODO Merge with following implementation section?
...
% TODO Merge with following conclusion.
...
% TODO Merge the next 6 sections to just `Improvements to Open Air Gestures'

% TODO Trim down - can almost totally remove this as it just repetition of the first introduction..

% TODO Remove summary of paper.
...
% TODO Trim down - can remove a lot of this as its just summarising the first half of the paper.
...
% TODO A lot of this (especially the structure) could be merged into the discussion of User Study 1.
...
% TODO Lift some of conclusion 1 here so that the whole paper is summarised.
